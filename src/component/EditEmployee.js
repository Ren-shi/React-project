      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Modal title</Modal.Title>
            ...
            <Modal.Footer>
            <button Class ="bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded" form="editmodal"> 
            Close
            </button>
            <button Class ="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" form="editmodal">
                Update 
                </button>
            </Modal.Footer>
      </Modal>
